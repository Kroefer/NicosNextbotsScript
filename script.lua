--Made By Kroefer
--Nicos nextbots scripts made by Darijus#1071
--i love u for using dis crappy goofy ahh shit
...
local Window = Library.CreateLib("Window", "DarkTheme")
    ...
    MainSection:NewButton("Infinite Jump", "Jump With no Limit", function()
        loadstring(game:HttpGet('https://cdn.wearedevs.net/scripts/Infinite%20Jump.txt'))()
    end)
    
    
    MainSection:NewToggle("epic vroom vroom and jump", "go vroom vroom mode", function(state)
        if state then
...
local MainSection = Main:NewSection("cool scripts")
    MainSection:NewButton("Infinite Yield", "gibes you the admen", function()
    ...
    PlayerSection:NewSlider("sonic speed", "ultra vroom vroom of death", 500, 16, function(s)
    ...
    PlayerSection:NewButton("torso coords", "shows coords in dev console", function()
...
ShitSection:NewButton("Speed With Noclip click here then hold shift", "('K'toggle,'-'slower,'='faster)",function(s)
...
---------------------------------------------------------------------------
ShitSection:NewButton("infnite jump (not working)", "PRESS ONLY ONCE", function(v) --dont remember thread sorry
...
otherstuff:NewButton("Backrooms", "idk bro it teleport u", function(v)
save_CFRAME = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1381.995849609375, -211.8748321533203, -326.79132080078125)
end)
otherstuff:NewButton("Flatgrass", "idk bro it teleport u", function(v)
save_CFRAME = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(13.710840225219727, 485.4750671386719, -1241.4857177734375)
end)
otherstuff:NewButton("Mall", "idk bro it teleport u", function(v)
save_CFRAME = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(13.710840225219727, 485.4750671386719, -1241.4857177734375)
end)
otherstuff:NewToggle("Monster not chase u(NOT WORKING)", "kinda useless", function(v)
...
ShitSection2:NewToggle("Monster ESP(NOT WORKING)", "magic e-s-p hahahe", function(v)
_G.monster_esp = v
...
local ShitSection3 = Main3:NewSection("Made By Kroefer")
